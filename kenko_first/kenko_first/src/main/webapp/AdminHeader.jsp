...
<div class="app-admin-wrap layout-sidebar-large">
    ...
    <div id="sideBar" class="side-content-wrap">
                ...
                <li class="nav-item">
                    <a class="nav-item-hold" href="#">
                        <img class="nav-icon" src="dist-assets/images/custom/map.svg"
                             alt="Lands"/>
                        <span class="nav-text" id="lblAdminHeaderDashboards">Dashboard</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-item-hold" href="#">
                        <img class="nav-icon" src="dist-assets/images/custom/plant.svg"
                             alt="Crops"/>
                        <span class="nav-text" id="lblAdminHeaderDetailsReports">Detailed Reports</span>
                    </a>
                    <div class="triangle"></div>
                </li>
                <%--  <li class="nav-item">
